...
import io.github.gaomingyuan666.cache.utils.RedisUtils;
...
@Slf4j
@Service
public class FixedWindowRateLimiterController extends AbstractFrequencyControlService<FrequencyControlDTO> {
    ...
    @Override
    protected LimiterTypeEnum getStrategyName() {
        return LimiterTypeEnum.FixedWindow;
    }
}
