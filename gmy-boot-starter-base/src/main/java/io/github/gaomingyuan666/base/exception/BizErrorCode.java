...
public enum BizErrorCode implements ErrorCode {
    SYSTEM_ERROR("SYSTEM_ERROR","系统出小差了，请稍后再试哦~~"),
    /**
     * 参数校验异常
     */
    PARAM_VALID("PARAM_VALID", "参数校验失败{0}"),
    /**
     * 业务异常
     */
    BIZ_ERROR("BIZ_ERROR", "{0}"),
    /**
     * 限流异常
     */
    FREQUENCY_LIMIT("FREQUENCY_LIMIT", "请求太频繁了，请稍后再试哦~~"),
    /**
     * 分布式锁异常
     */
    LOCK_ERROR("LOCK_LIMIT", "分布式锁异常"),
